...
// Inclui os headers do ooz. Certifique-se que kraken.h está na mesma pasta.
#include "kraken.h"
...
int main(int argc, char* argv[]) {
    ...
    if (mode == "d") { // Decompress
        ...
        // Chama a função de descompressão do ooz
        // Nota: O nome da função pode variar dependendo da versão do ooz, mas geralmente é Kraken_Decompress
